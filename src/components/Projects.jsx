...
const featuredProjects = [
  ...
  },
  {
    ...
    category: "Full Stack",
    desc: "Full-stack course enrollment platform with user authentication, role-based access, admin course management, and secure student enrollments.",
    image: "/course.png",
    stack: ["React", "Node.js", "Express", "MongoDB", "JWT", "REST APIs"],
    architecture: ["Student auth flows", "Admin course management", "Role-based access", "Enrollment workflows"],
    challenge: "Built a structured learning platform that keeps course discovery, enrollment, and admin management simple and secure.",
    repo: "https://github.com/manish-vm/",
    demo: "https://online-course-enrollment-system-fro.vercel.app/",
  },
  {
